...
| status code | 内容                           | 出力メッセージ                                    |
|-------------|--------------------------------|---------------------------------------------------|
| 400         | 入力内容の不正                 | 処理に失敗しました。再度お試しください。          |
| 401         | 認証失敗                       | ユーザー名・パスワードに誤りがあります。          |
| 404         | 入力されたユーザーが存在しない | ユーザー名・パスワードに誤りがあります。          |
| 500         | db接続不可                     | サーバーエラー / しばらくしてから再度お試しください。 |
| その他      | サーバーエラー                 | サーバーエラー / しばらくしてから再度お試しください。 |
...
| status code | 内容               | 出力メッセージ                                    |
|-------------|--------------------|---------------------------------------------------|
| 403         | トークンの認可失敗 | 許可されていないアクセスがありました。            |
| 500         | データの取得失敗   | サーバーエラー / しばらくしてから再度お試しください。 |
...
| 400         | 入力内容の不正                     | 処理に失敗しました。再度お試しください。             |
| 403         | トークンの認可失敗                 | 許可されていないアクセスがありました。               |
| 422         | 単語帳タイトル/単語/翻訳が長すぎる | 入力された内容の一部が登録できる上限を超えています。 |
